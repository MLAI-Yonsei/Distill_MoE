...
''''''
from transformers.models.llama_distill_moe.configuration_llama_distill_moe import DistillLlamaConfig
from transformers.models.llama_distill_moe_test.configuration_llama_distill_moe_test import testDistillLlamaConfig
from transformers.models.llama_moe.configuration_llama_moe import LlamaMoEConfig

from transformers.models.llama_distill_moe.modeling_llama_distill_moe import DistillLlamaForCausalLM
from transformers.models.llama_distill_moe_test.modeling_llama_distill_moe_test import testDistillLlamaForCausalLM
from transformers.models.llama_moe.modeling_llama_moe import LlamaMoEForCausalLM


AutoConfig.register("distill_llama", DistillLlamaConfig)
AutoConfig.register("test_distill_llama", testDistillLlamaConfig)
AutoConfig.register("llama_moe", LlamaMoEConfig)
# Model 등록
AutoModelForCausalLM.register(DistillLlamaConfig, DistillLlamaForCausalLM)
AutoModelForCausalLM.register(testDistillLlamaConfig, testDistillLlamaForCausalLM)
